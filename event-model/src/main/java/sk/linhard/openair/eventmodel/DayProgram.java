...
public class DayProgram implements Iterable<Session>, Serializable {
	...
	/**
	 * Returns true iff this program contains any relevant performances with
	...
	/**
	 * Return all relevant performances with regard to given time.
	 * Relevant performance is performance that is eigher running or in the future.
	 * 
	 * @param aTime Current time.
	...
	/**
	 * Filter either the old version or the new version of the program.
	 * performances will be sorted by start.
	 * 
	 * new version contains all performances that have not changed
	 * an new versions of those that changed.
	 * 
	 * old version contains all performances that have not changed
	 * an old versions of those that changed.
	 * 
