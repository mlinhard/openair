...
public class Event implements Iterable<Location>, Serializable {
   ...
   /**
    * anOldVersion == true : Returns the clone of the original version of the event, where all
    * changes are discarded and only original versions of all changes are left. anOldVersion ==
    * false : Returns the clone of the original version of th event, where there are no changes and
    * the planned model corresponds to the actual model of the original model.
    * 
    * @param anOldVersion
    *           flag telling whether old or new version is to be returned
